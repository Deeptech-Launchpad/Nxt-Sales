    ...
    <div style={{
      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: 36, width: '100%', maxWidth: 420, boxShadow: '0 24px 64px rgba(0,0,0,.3)' }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 16, color: '#344054', marginTop: 2 }}>Reset your password</div>
        </div>

        {!sent ? (
          <form onSubmit={handleSubmit}>
            <p style={{ margin: '0 0 18px', color: '#475569', fontSize: 16.5, lineHeight: 1.5 }}>
              Enter the email address on your account and we'll send you a link to set a new password.
            </p>
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: 'block', fontSize: 15, fontWeight: 600, color: '#374151', marginBottom: 5 }}>Work Email</label>
              <input
          ...
          <div>
            <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 8, padding: '14px 16px', marginBottom: 16, textAlign: 'center' }}>
              ...
              <p style={{ margin: 0, color: '#166534', fontSize: 16, lineHeight: 1.5 }}>
            ...
            {devResetLink && (
              <div style={{ background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 8, padding: '12px 14px', marginBottom: 16 }}>
                <p style={{ margin: '0 0 8px', color: '#92400e', fontSize: 15, fontWeight: 600 }}>
                  Local/dev mode — no SMTP configured, so here's the link directly:
                </p>
                <a href={devResetLink} style={{ fontSize: 15.5, color: '#1d4ed8', wordBreak: 'break-all' }}>{devResetLink}</a>
              </div>
            )}
