...
import { loadPersonalization } from '../utils/personalization'
...
export default function Dashboard() {
  ...
  // There is no server-side profile-personalization endpoint (Settings/User
  // Personalization is a separate, not-yet-built feature) — Profile.jsx
  // already stores the avatar client-side per user id, so this reads that
  // same store rather than calling an endpoint that doesn't exist.
  useEffect(() => {
    setProfileStyle(loadPersonalization(user?.id))
  }, [user?.id])
