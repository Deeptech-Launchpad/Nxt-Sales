...
const NAV_ITEMS = [
  { key: 'composer',    icon: 'mail',       label: 'Composer' },
      ...
      <nav className="et-nav">
        {NAV_ITEMS.map(item => (
          <button
            ...
            onClick={() => item.key === 'composer' ? onCompose() : setSection(item.key)}
          >
  ...
  return (
    <div className="et-section">
      <div className="et-panel-header">
        <div className="et-panel-heading">
          <h2 className="et-panel-title">Compose Email</h2>
          <p>Build, preview and send from one focused workspace.</p>
        </div>
        <span className="et-flow-badge"><MaterialIcon name="bolt" /> 4 quick steps</span>
      </div>
      ...
      <div className="et-compose-split">
        ...
        <div className="et-form-card">
          ...
          {/* CC / BCC */}
          <div className="et-form-row et-field-copy">
                ...
                <div className={`et-upload-box ${isBeforeAfter ? 'required' : ''}`}>
                  ...
                  {beforeThumb
                    ...
                    : beforeFile?.type === 'application/pdf'
                      ? <span className="et-upload-pdf"><MaterialIcon name="picture_as_pdf" /> PDF Attached</span>
                      : <>
                          <MaterialIcon name="upload_file" className="et-upload-icon" />
          ...
          <div className="et-form-group et-field-body">
            ...
            <textarea className="et-textarea" rows="4"
        ...
        <div className="et-preview-card">
          <div className="et-preview-header">
            <h3><MaterialIcon name="mark_email_read" /> Email Preview</h3>
          </div>
            ...
            <div className="et-gmail-envelope">
              {previewHtml
                ...
                : <p className="et-preview-placeholder">
                    Add the recipient and client details, then select <strong>Compile Preview</strong>. Your ready-to-send email will appear here.
                  </p>
              }
            </div>
          </div>
    ...
    <div className="et-section">
      <div className="et-panel-header">
        <div className="et-panel-heading">
          ...
          <p>Manage email delivery, AI assistance and your default signature.</p>
        </div>
      </div>

      <div className="et-panel-body et-settings-layout">
        <div className="et-settings-card et-settings-config">
          <div className="et-settings-card-head">
            <div className="et-settings-icon"><MaterialIcon name="tune" /></div>
            <div>
              <div className="et-settings-title">Delivery &amp; AI</div>
              <p>Connect Gmail and configure the assistant used by email templates.</p>
            </div>
          </div>

          <div className={`et-connection-strip ${localValid ? 'connected' : ''}`}>
            <div className="et-connection-copy">
              <span className="et-connection-dot" />
              <div>
                <strong>{localValid ? 'Gmail connected' : 'Gmail not connected'}</strong>
                <span>{localValid ? 'Ready to send emails' : 'Connect an account to start sending'}</span>
              </div>
            </div>
            {localValid ? (
              <button className="et-btn et-btn-secondary" onClick={disconnectGmail}>Disconnect</button>
            ) : (
              <button className="et-btn et-btn-secondary" onClick={connectGmail} disabled={connecting}>
          ...
          <div className="et-settings-divider"><span>Gmail delivery</span></div>
          ...
          <div className="et-settings-divider"><span>AI assistant</span></div>
