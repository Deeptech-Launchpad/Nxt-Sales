    ...
    <div style={{
      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: 36, width: '100%', maxWidth: 420, boxShadow: '0 24px 64px rgba(0,0,0,.3)' }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 13, color: '#64748b', marginTop: 2 }}>Set a new password</div>
        </div>
        ...
        {!loading && tokenError && (
          <div>
            ...
            <button onClick={() => navigate('/forgot-password')} style={{ width: '100%', background: '#0f172a', color: '#fff', border: 'none', borderRadius: 8, padding: 12, fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
              Request a new link
            </button>
          </div>
        )}
        ...
        {!loading && !tokenError && success && (
          <div style={{ textAlign: 'center', padding: '16px 0' }}>
            ...
            <h3 style={{ margin: '0 0 8px', color: '#0f172a', fontSize: 18 }}>Password updated!</h3>
